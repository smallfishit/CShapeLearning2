...
namespace Q02.Test
{
    ...
    public class VolumnTest
    {
        ...
        [Test]
        public void ShowScoreResult_InputScore_ReturnOutOfRange(decimal length, decimal width, decimal height, decimal volumn)
        {
            //建立物件
            VolumnCalculator volumnCal = new VolumnCalculator();
            //顯示結果
            decimal result = volumnCal.CalculateVolumn(length, width, height);
            //驗證結果是否正確
